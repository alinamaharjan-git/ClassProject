...
class KbcTest implements ActionListener
{
    ...
    JLabel lb1,lb2;
    ButtonGroup bg;
    String ques[]={"who developed java?","capitol of italy","baby frog is known as.."};
    String op1[]={"Tim","peris","tadpole"};
    String op2[]={"steve","Delhi","aa"};
    String op3[]={"mark","Rome","bb"};
    String op4[]={"james","bern","cc"};
    String ans[]={"james","Rome","dd"};
    int cn;
    KbcTest()
    {
        fr=new JFrame();
